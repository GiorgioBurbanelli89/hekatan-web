...
using System.Text;
using Hekatan.Core;
using Hekatan.Document.Core;
using Hekatan.Document.Core.Segments;

namespace Hekatan.Document.Archive
{
    /// <summary>
    /// read hcalc/cpd or hcalcz/cpdz file
    /// </summary>
    ...
    public class CpdReader(string filePath, CpdReaderSettings settings)
    {
        ...
        public string ReadAllText()
        {
            ...
            var ext = Path.GetExtension(_fullPath);
            if (
                string.Equals(ext, ".hcalcz", StringComparison.OrdinalIgnoreCase) ||
