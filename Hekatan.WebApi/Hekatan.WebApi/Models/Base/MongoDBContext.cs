...
using Hekatan.WebApi.Utils.Attributes;
using log4net;
using MongoDB.Bson.Serialization.Conventions;
using MongoDB.Driver;

namespace Hekatan.WebApi.Models.Base
{
    public class MongoDBContext
    {
        ...
        /// 用户集合
        /// </summary>
        public IMongoCollection<HekatanUserModel> HekatanUsers => Collection<HekatanUserModel>();
        public IMongoCollection<HekatanFileModel> FileObjects => Collection<HekatanFileModel>();
        #endregion
    }
}
