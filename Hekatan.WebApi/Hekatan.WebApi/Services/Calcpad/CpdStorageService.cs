...
using Hekatan.Document.Core.Utils;
...
using Hekatan.WebApi.Utils.Files;
...
namespace Hekatan.WebApi.Services.Hekatan
{
    ...
    ) : ISingletonService
    {
        ...
        {
            var cpdModel = await db.AsQueryable<HekatanFileModel>()
        ...
        )
        {
            ...
            foreach (var includeLine in includeLines)
            {
                ...
                var includeModel = await db.AsQueryable<HekatanFileModel>()
