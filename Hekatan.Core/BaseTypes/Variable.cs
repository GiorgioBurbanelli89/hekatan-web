...
namespace Hekatan.Core
{
    internal class Variable
    {
        ...
        // v7.6.1: Soporte para constantes con #const
        internal bool IsConstant => _isConstant;
        private bool _isConstant;
        internal void MakeConstant() => _isConstant = true;
        ...
        {
            // v7.6.1: Verificar si es constante antes de asignar
            if (_isConstant && _isIntialised)
                throw new MathParserException(Messages.Cannot_modify_constant);
