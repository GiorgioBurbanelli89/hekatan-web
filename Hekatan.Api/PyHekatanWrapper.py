...
# Load PyHekatan
import sys, os
programPath = os.environ.get("PROGRAMFILES") + r"\Hekatan"
sys.path.append(programPath)
clr.AddReference(programPath + r"\PyHekatan.dll")

# Import the specific classes from the PyHekatan namespace
from System import Type, Activator

# Get the types from the assembly
SettingsType = Type.GetType("PyHekatan.Settings, PyHekatan")
MathSettingsType = Type.GetType("PyHekatan.MathSettings, PyHekatan")
PlotSettingsType = Type.GetType("PyHekatan.PlotSettings, PyHekatan")
CalculatorType = Type.GetType("PyHekatan.Calculator, PyHekatan")
ParserType = Type.GetType("PyHekatan.Parser, PyHekatan")
