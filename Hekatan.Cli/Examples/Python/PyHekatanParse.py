...
from PyHekatanWrapper import Parser, Settings
...
print("Parsing Hekatan worksheets with Python + PyHekatan.")
inputFileName = docsPath + r"\Hekatan\Examples\Mechanics\Structural Analysis\Continuous beam\Continuous beam.txt"
...
# Apply the Hekatan Html template
templateFile = r"c:\Program Files\Hekatan\doc\template.html"
