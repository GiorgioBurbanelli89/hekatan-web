...
EndFragment:0000000004";
        ...
        internal async Task<string[]> GetInputFieldsAsync()
        {
            ...
            {
                MessageBox.Show(AppMessages.Error_getting_input_fields_values, "Hekatan", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            return null;
        }
        ...
        internal CoreWebView2PrintSettings CreatePrintSettings()
        {
            ...
            settings.HeaderTitle = "Created with Hekatan";
            settings.FooterUri = "";
            settings.PrinterName = "Hekatan";
            return settings;
        }
    }
}